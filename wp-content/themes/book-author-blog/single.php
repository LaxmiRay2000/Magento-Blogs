...
<div id="primary" class="content-area">
	<main id="main" class="site-main">
		<?php do_action('book_author_blog_before_default_page'); ?>
			<div class="post-details-page">
				...
				if(true == $s_post_el_is_on['show_post_navigation']):
					book_author_blog_post_page_navigation();
				endif;

				if( true == $s_post_el_is_on['show_post_author_box'] ) :
					book_author_blog_postedby();
				endif;
				...
				if (true == $s_post_el_is_on['show_recommend_posts']) :
					echo '<div class="related-post-wrapper">';
						book_author_blog_cats_related_post();
					echo '</div>';
				endif;
				?>
			</div>
		<?php do_action('book_author_blog_after_default_page'); ?>
	</main><!-- #main -->
</div><!-- #primary -->
<?php
get_footer();
