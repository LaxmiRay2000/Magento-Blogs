 ...
 * @access public
 */
final class Book_Author_Blog_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Book_Author_Blog_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new Book_Author_Blog_Customize_Section_Pro(
				$manager,
				'go-pro',
				array(
					'priority'       => 1,
					'pro_text' => esc_html__( 'Upgrade To Pro', 'book-author-blog' ),
					'pro_url'  => 'https://rswpthemes.com/author-portfolio-pro-wordpress-theme/',
				)
			)
		);
	}
...
Book_Author_Blog_Customize::get_instance();
