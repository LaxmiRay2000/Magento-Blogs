...
function book_author_blog_cats_related_post() {
    $post_id = get_the_ID();
    $cat_ids = array();
    ...
    $get_post_page_sidebar = get_theme_mod('post_sidebar', 'both');
    ...
    if($related_cats_post->have_posts()):
        ...
        <div class="recommended-post-section mt-5 mb-5">
			<h4 class="related-post-title text-left"><?php esc_html_e( 'Recommended Posts', 'book-author-blog' ); ?></h4>
        	<?php
