<?php
// Adds widget: Widget
class Book_Author_Blog_Latest_Posts_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'book_author_blog_latest_posts',
			esc_html__( '[Book Author Blog] Latest Posts', 'book-author-blog' )
		);
	}
		...
		?>
			<ul class="recent-post-widget">
				...
				while ( $resent_post->have_posts() ) :
					...
					$post_classes = 'book-author-blog-recent-post';
					if (!has_post_thumbnail()) {
						$post_classes = 'book-author-blog-recent-post no-post-thumbnail ';
					}
					?>
				<li <?php post_class($post_classes); ?>>
					<?php if(has_post_thumbnail()) : ?>
					<div class="recent-post-thumb">
						<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'book-author-blog-recent-post' ); ?></a>
					</div>
					<?php endif; ?>
					<div class="recent-widget-content">
						...
						<div class="recent-post-date">
							<?php book_author_blog_posted_on(); ?>
						</div>
						<?php endif; ?>
					</div>
				</li>
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'book-author-blog' ); ?></label>
...
function book_author_blog_latest_posts_wr() {
	register_widget( 'Book_Author_Blog_Latest_Posts_Widget' );
}
add_action( 'widgets_init', 'book_author_blog_latest_posts_wr' );