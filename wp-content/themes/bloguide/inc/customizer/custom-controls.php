 ...
 */
class  Bloguide_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class  Bloguide_Dropdown_Category_Control extends WP_Customize_Control {
...
class  Bloguide_Note_Control extends WP_Customize_Control {
...
class  Bloguide_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class  Bloguide_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="bloguide-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class  Bloguide_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="bloguide-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( (string) $this->value(), (string) $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class  Bloguide_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class  Bloguide_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="bloguide-sortable-list">
 
      <?php
       foreach ( $values_choices as $value ){  ?>
	        <li>
	            <input class="bloguide-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
	            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
	          <i class="dashicons dashicons-menu bloguide-drag-handle"></i>
	        </li>
        ...
        <li class="sortable-hideme">
          <input class="bloguide-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
Class  Bloguide_Customize_Horizontal_Line extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class  Bloguide_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class  Bloguide_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="bloguide-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'bloguide' ); ?>" class="bloguide-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}

class Bloguide_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
