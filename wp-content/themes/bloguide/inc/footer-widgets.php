...
class  Bloguide_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'bloguide';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'bloguide' ), $i ),
...
// Initialize.
$bloguide_footer_widgets = new  Bloguide_Footer_Widgets();
