...
if ( ! class_exists( 'Bloguide_Popular_Post' ) ) :

     
    class Bloguide_Popular_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive Popular posts.', 'bloguide' ),
            );
            $this->default_title = __( 'Top Posts &amp; Pages', 'bloguide' );

            parent::__construct( 'bloguide_popular_post', esc_html__( 'TP : Popular Posts', 'bloguide' ), $tp_widget_popular_post );
        ...
        function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'bloguide' ); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
            </p>
    
            <p>
                <label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php esc_html_e( 'Maximum number of posts to show (no more than 10):', 'bloguide' ); ?></label>
            ...
            <p id="select-category">
                <label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'bloguide' ); ?></label>
                <select id="<?php echo esc_attr( $this->get_field_id('category') ); ?>" name="<?php echo $this->get_field_name('category'); ?>" class="widefat" style="width:100%;">
                    ...
                    <?php 
                    $categories = bloguide_category_choices();
            ...
            <hr>
            <p>
                <label><?php esc_html_e( 'Sort By:', 'bloguide' ); ?></label>
                <ul>
                    <li>
                        <label>
                            ...
                            <?php esc_html_e( 'Published Date', 'bloguide' ); ?>
                        </label>
                    </li>
                    <li>
                        <label>
                            ...
                            <?php esc_html_e( 'Alphabetical ', 'bloguide' ); ?>
                        </label>
                    </li>
                </ul>
            </p>
        ...
        function update( $new_instance, $old_instance ) {
            ...
            $instance['category'] = bloguide_sanitize_single_category( $new_instance['category'] );
        ...
        public static function defaults() {
            return array(
                'title'    => esc_html__( 'Popular Posts ', 'bloguide' ),
                'count'    => absint( 4 ),
                'types'    => 'post',
                'ordering' => 'date',
                'category'  => '',
