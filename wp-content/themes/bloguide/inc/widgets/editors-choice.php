...
if ( ! class_exists( 'Bloguide_Editors_Choice' ) ) :

     
    class Bloguide_Editors_Choice extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_editors_choice = array(
                ...
                'description' => esc_html__( 'Retrive Editors Choice.', 'bloguide' ),
            );
            $this->default_title = __( 'Top Posts &amp; Pages', 'bloguide' );

            parent::__construct( 'bloguide_editors_choice', esc_html__( 'TP : Editors Choice', 'bloguide' ), $tp_widget_editors_choice );
                ...
                <li class="has-post-thumbnail">
                    ...
                    <div class="entry-container">
                        ...
                        <div class="entry-meta">
                            <?php bloguide_posted_on( $post->ID ); ?> 
                            <span class="min-read"><?php echo bloguide_reading_time( $post->ID ); ?></span>                          
                        </div>
                    </div>
                </li>
            <?php endforeach; ?>
        ...
        public static function defaults() {
            return array(
                'title'    => esc_html__( 'Editor Choice ', 'bloguide' ),
                'count'    => absint( 4 ),
                'types'    => 'post',
                'category'  => '',
